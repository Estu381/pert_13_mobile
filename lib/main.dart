...
class _ImageUploadWidgetState extends State<ImageUploadWidget> {
  ...
  Future<void> _uploadImage() async {
    if (_imageFile != null) {
      ...
      final result = await ApiService.uploadImage(_imageFile!, nama, description);
  ...
  void _imageData() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ImageDataPage()),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: _imageData, // Panggil fungsi _viewImages
