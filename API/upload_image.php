...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_FILES["image"]) && isset($_POST["description"]) && isset($_POST["nama"])) {
        $image = $_FILES["image"];
        ...
        if (move_uploaded_file($image["tmp_name"], $uploadPath)) {
            ...
            $sql = "INSERT INTO uploaded_images (file_name, description, file_path, nama) VALUES ('$imageName', '$description', '$filePath', '$nama')";
